    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Buy', 'Buy'), ('Rent', 'Rent'), ('Commercial', 'Commercial'), ('PG', 'PG/Co-living'), ('Plot', 'Plots/Land'), ('Luxury', 'Luxury'), ('ShortStay', 'Short Stay'), ('New', 'New Projects')], max_length=20)),
